...
class PhpDom
{
    ...
    public function find($query)
    {
        ...
        return $xpath->query(new CssToXPath($query));
    }
    public function findInElement($element , $query)
    {
        $xpath = new DOMXPath($this->dom);
        return $xpath->query(new CssToXPath($query),$element);
    }
...
class PhpElement {
    ...
    public function html() {
        ...
        foreach ($this->element->childNodes as $child) {
            $html .= $this->element->ownerDocument->saveHTML($child);
        }
        return $html;
    }
}
